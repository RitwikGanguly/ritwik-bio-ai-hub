...
import backgroundImg from "@/assets/background-portfolio.avif";
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 animate-fade-in">
            ...
            <div className="flex gap-4 pt-2">
              ...
              >
                <a
                  href="https://scholar.google.com/citations?user=LJT_N_0AAAAJ&hl=en"
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          <div className="flex justify-center md:justify-end animate-slide-up">
            <div className="relative">
              ...
              <div className="relative w-80 h-80 md:w-96 md:h-96 rounded-3xl overflow-hidden border-4 border-primary/20 shadow-elegant">
                <img 
                  src={profileImg} 
